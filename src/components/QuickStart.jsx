        ...
        <Timeline mode="left" style={styles.timeline}>
          <Timeline.Item dot="📄">
            <Text delete style={styles.text}>
              Clone or fork{" "}
              <a
                href="https://github.com/ethereum-solidity_app/ethereum-solidity_app#-quick-start"
                target="_blank"
                rel="noopener noreferrer"
              >
                ethereum-solidity_app
              </a>{" "}
            </Text>
          </Timeline.Item>
          ...
          <Timeline.Item dot="🧰">
            <Text delete={isServerInfo} style={styles.text}>
              ...
              <a
                href="https://moralis.io?utm_source=boilerplatehosted&utm_medium=todo&utm_campaign=ethereum-solidity_app"
                target="_blank"
                rel="noopener noreferrer"
              >
                Moralis
          ...
          <Timeline.Item dot="💿">
            <Text delete={isInchDex} style={styles.text}>
              Install{" "}
              <a
                href="https://moralis.io/plugins/1inch/?utm_source=boilerplatehosted&utm_medium=todo&utm_campaign=ethereum-solidity_app"
                target="_blank"
                rel="noopener noreferrer"
              >
